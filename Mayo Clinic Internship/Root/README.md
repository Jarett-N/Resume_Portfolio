...
- **Health Data Integration:** Displays key metrics such as weight, BMI, exercise duration, and daily caloric intake.
- **Backend API:** Node.js/Express-based API to fetch and update health data.
